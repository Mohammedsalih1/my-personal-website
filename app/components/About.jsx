...
const About = () => {
    return (
        ...
        >
            ...
            <motion.h2 className={`text-center text-5xl ${styles.ovo}`}
            initial={{opacity: 0, y: -20}} whileInView={{opacity: 1, y: 0}} transition={{duration: 0.5, delay: 0.}}
            >About me</motion.h2>
            ...
            >
                ...
                >
                    <p className={`mb-10 max-w-2xl ${styles.ovo}`}>I am an experienced Frontend Developer with over 3 years
                        of professional expertise in the field. throughout my career,
                        I have had the privilege of colloaborating with prestigious 
                        organizations, contrubting to their success and growth.</p>

                    <motion.ul className='grid grid-col-1 sm:grid-cols-3 gap-6 max-w-2xl'
                    initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{duration: 0.8, delay: 1}}>
                        {infoList.map(({icon, iconDark, title, description}, index) => (
                            ...
                            hover:bg-[#fcf4ff] hover:-translate-y-1 duration-500 hover:shadow-[4px_4px_0px_#000]`}
                    ...
                    className={`my-6 text-gray-700 font-${styles.ovo}`}>Tools i use</motion.h4>
